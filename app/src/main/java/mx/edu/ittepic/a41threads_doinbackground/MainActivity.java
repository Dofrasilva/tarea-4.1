package mx.edu.ittepic.a41threads_doinbackground;
...
public class MainActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnasynk1 =  findViewById(R.id.botonhilo);
        btnasynk2 =  findViewById(R.id.botonasynk);
        ...
        btnasynk1.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btnasynk2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {
                ...
                while(i<=numero-1){
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            txtContador2.setText("Progreso: "+i);
                        }
                    });
                }
            }
    ...
    private class  AsyncTarea extends AsyncTask<Integer, Integer,Boolean> {
        ...
        protected void onProgressUpdate(Integer... values) {
            ...
            txtContador.setText("Progreso: "+((values[0].intValue())));
        }
